...
<section class="w-full mx-auto max-w-7xl md:mt-6 overflow-hidden md:rounded-[2.5rem] bg-slate-900">
    ...
    <div class="relative min-h-[600px] lg:min-h-[500px] lg:aspect-[21/9] flex items-center px-6 lg:px-20 py-20">
        ...
        <div class="relative z-10 max-w-2xl">
            ...
            {{-- Description --}}
            <p class="text-lg lg:text-xl text-slate-300 mb-10 leading-relaxed max-w-lg line-clamp-3 lg:line-clamp-none font-light">
                {{ $hero->description }}
            </p>

            {{-- Button --}}
            <div class="flex flex-col sm:flex-row gap-4">
                <a href="#produk" class="inline-flex items-center justify-center px-8 py-4 bg-amber-500 hover:bg-amber-400 text-slate-900 font-bold rounded-2xl transition-all shadow-xl shadow-amber-500/20 group">
                    Lihat Produk
                ...
                <a href="#tentang" class="inline-flex items-center justify-center px-8 py-4 bg-white/10 hover:bg-white/20 text-white font-semibold rounded-2xl backdrop-blur-md transition">
                    Tentang Kami
                </a>
            </div>
        </div>
